...
String boyut oluşturun...
     ...
     */
        ...
        if (hangiKahve.equalsIgnoreCase("Turk Kahvesi")||hangiKahve.equalsIgnoreCase("kurt kahvesi")){
        ...
        System.out.println("Sut eklememizi ister misiniz? Lutfen Evet ya da Hayir olarak cevabinizi giriniz: ");
        ...
        if (boyut.equalsIgnoreCase("buyuk boy")||boyut.equalsIgnoreCase("büyük")) {
